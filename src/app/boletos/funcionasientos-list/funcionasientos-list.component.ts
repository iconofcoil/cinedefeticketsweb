...
@Component({
  selector: 'app-funcionasientos-list',
  templateUrl: './funcionasientos-list.component.html',
  styleUrls: ['./funcionasientos-list.component.css']
})

export class FuncionAsientosListComponent implements OnInit, AfterViewInit {
